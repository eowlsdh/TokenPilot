...
final class TokenMonitorTests: XCTestCase {
    ...
    func testProviderMarksUseSemanticBrandSystemWithAccessibilityMotionAndContrast() throws {
        ...
        XCTAssertTrue(componentsSource.contains("Image(systemName: provider.iconName)"))
        XCTAssertTrue(componentsSource.contains(".symbolRenderingMode(.monochrome)"))
        XCTAssertFalse(componentsSource.contains("struct Diamond: Shape"))
        XCTAssertFalse(componentsSource.contains("Text(\"xAI\")"))
    ...
    func testRedesignedCapacityConsoleKeepsCompactDisclosureAndSourceOnlyContracts() throws {
        ...
        XCTAssertTrue(settingsCollapsed.contains("DisclosureCard( initiallyExpanded: healthNeedsAttention, remembered: remembered(\"source\"), accessibilityLabel: model.t(\"Source health\")"))
        XCTAssertTrue(settingsCollapsed.contains("DisclosureCard( initiallyExpanded: healthNeedsAttention, remembered: remembered(\"diagnostics\"), accessibilityLabel: model.t(\"Provider Diagnostics\")"))
