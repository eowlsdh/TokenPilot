...
private func value(_ object: [String: Any], path: String) -> Any? {
...
private func intValue(_ value: Any?) -> Int? {
    ...
    if let string = value as? String { return Int(string.trimmingCharacters(in: .whitespacesAndNewlines).replacingOccurrences(of: "%", with: "")) }
    return nil
}
